...
public class ApkSignerTool {
    ...
    private static void sign(String[] params) throws Exception {
        ...
        for (SignerParams signer : signers) {
            ...
            KeyConfig config = new KeyConfig.Jca(signer.privateKey);
            // lalaki fix APKSigner
            ApkSigner.SignerConfig signerConfig = new ApkSigner.SignerConfig.Builder(v1SigBasename, config, signer.certs).build();
