...
public class InputParam {
    ...
    public static boolean delMetaInf;
    public static boolean onlyV3V4Sign;
    private InputParam(
            File mappingFile,
            boolean use7zip,
            boolean useSign,
    ...
    public static class Builder {
        ...
        public Builder setDelMetaInf(boolean mDelMetaInf) {
            delMetaInf = mDelMetaInf;
            return this;
        }

        public Builder setOnlyV3V4Sign(boolean mOnlyV3V4Sign) {
            onlyV3V4Sign = mOnlyV3V4Sign;
            return this;
        }
