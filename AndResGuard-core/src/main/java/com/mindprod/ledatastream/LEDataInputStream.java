 ...
 * @since 1998
 */
public final class LEDataInputStream implements DataInput, AutoCloseable {
    // ------------------------------ CONSTANTS ------------------------------
    ...
    private final BufferedReader buf_read;
    /**
    ...
    private final InputStreamReader in_read;
    ...
    public LEDataInputStream(InputStream in) {
        ...
        this.in_read = new InputStreamReader(dis);
        this.buf_read = new BufferedReader(this.in_read);
        work = new byte[8];
    }
